...
Potential changes to this structure can occur in the 'Ensemble Learning Preparation' folder. For this case, we created a copy of the DS2 folder called 'DS2 Ensemble', so that we could clearly differentiate between the data used for the different train-test-validation and train-test-metatest-validation splits, according to the different approaches
